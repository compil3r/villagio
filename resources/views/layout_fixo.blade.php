...
<head>
    ...
    <!-- favicon -->
    <link href="img/favicon.ico" rel="icon" sizes="32x32">
...
<body class="choc ">
    ...
    <div class="content-wrapper">
        ...
        <header class="init choc no-section-image">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://configurador.villaggioaluminios.com.br/Login.aspx?ReturnUrl=%2fDefault.aspx&ReturnUrl=%2fDefault.aspx" >
                                            <div class="box">
                                                <div data-hover="Portal"> Portal <span class="ml-3 ti-user"></span></div>
                                            </div>
                                        </a>
                                    </li>
    ...
    <!-- #modal-video vertical centered and full screen -->
   @yield('modal')
    <!-- /#modal-video -->
    <!-- plugin JS -->
...
//   });
  ...
  //on click in #icone-play open modal video and play video
    $('#icone-play').click(function(){  
        ...
        //modal on close stop video
        $('#modal-video').on('hidden.bs.modal', function (e) {
            $('#video-modal').trigger('pause');
        });

        //modal on show play video
        $('#modal-video').on('shown.bs.modal', function (e) {
            $('#video-modal').trigger('play');
        });
